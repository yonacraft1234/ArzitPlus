...
namespace ArzitPlus
{
    internal class StudentMessageAdapter : BaseAdapter<Message>
    {
        Context context;
        ...
        public StudentMessageAdapter(Context context, List<Message> objects)
        {
        ...
        {
            LayoutInflater layoutInflater = ((StudentMessageActivity)context).LayoutInflater;
    ...
    internal class StudentMessageAdapterViewHolder : Java.Lang.Object
    {
