...
namespace ArzitPlus
{
    internal class StudentProfileAdapter : BaseAdapter<Lesson>
    {
        ...
        public StudentProfileAdapter(Context context, List<Lesson> objects)
        {
        ...
        {
            LayoutInflater layoutInflater = ((StudentProfileActivity)context).LayoutInflater;
            ...
            if (lesson != null)
            {
                student.Text = lesson.teacherName;
    ...
    internal class StudentProfileAdapterViewHolder : Java.Lang.Object
    {
