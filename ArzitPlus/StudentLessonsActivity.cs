...
namespace ArzitPlus
{
    [Activity(Label = "StudentLessonsActivity")]
    public class StudentLessonsActivity : Activity
    {
        StudentLessonsAdapter lessonsAdapter;
        ...
        private void Listener_OnOrderRetrieved(object sender, LessonEventListener.LessonEventArgs e)
        {
            ...
            lessonsAdapter = new StudentLessonsAdapter(this, list);
