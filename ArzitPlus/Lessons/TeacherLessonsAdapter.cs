...
namespace ArzitPlus
{
    internal class TeacherLessonsAdapter : BaseAdapter<Lesson>
    {
        ...
        public TeacherLessonsAdapter(Context context, List<Lesson> objects)
        {
        ...
        {
            LayoutInflater layoutInflater = ((TeacherLessonsActivity)context).LayoutInflater;
    ...
    internal class TeacherLessonsAdapterViewHolder : Java.Lang.Object
    {
