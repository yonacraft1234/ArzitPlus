...
namespace ArzitPlus
{
    internal class Student : Java.Lang.Object, IOnSuccessListener
    {
        ...
        public const string COLLECTION_USER_FILE = "currentStudentFile";
        ...
        public Student(string username, string email, string password, string phone, string address, string city, Bitmap profilePic)
        {
        ...
        public async Task<bool> Register()
        {
            ...
            try
            {
                ...
                images = storageRef.Child("/images/students/" + this.password);
        ...
        public async Task<bool> Logout()
        {
            try
            {
                var editor = Application.Context.GetSharedPreferences(Student.COLLECTION_USER_FILE, FileCreationMode.Private).Edit();
